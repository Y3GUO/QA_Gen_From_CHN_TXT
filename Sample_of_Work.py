''' ByYutongGuo20230803 QA生成脚本'''

#Setup
os.system('pip install transformers')
os.system('git clone https://github.com/amontgomerie/question_generator/')
os.system('pip install -U pip setuptools wheel')
os.system('pip install -U spacy')
os.system('python -m spacy download en_core_web_sm')
os.system('pip install sentencepiece')
os.system('git clone https://github.com/google/sentencepiece.git')
os.system(' cd sentencepiece')
os.system(' mkdir build')
os.system(' cd build')
os.system(' cmake .. -DSPM_ENABLE_SHARED=OFF -DCMAKE_INSTALL_PREFIX=./root')
...
translated_qa_output = []
# Loop through the QA pairs and translate both the question and the answer
for qa_pair in qa_list:
    translated_question = translate_english_to_chinese(qa_pair['question'])
    translated_answer = translate_english_to_chinese(qa_pair['answer'])
    translated_qa_output.append({
        'question': translated_question,
        'answer': translated_answer
    })
# Now translated_qa_output is a list of QA pairs where the questions and answers have been translated to Chinese
for pair in translated_qa_output:
